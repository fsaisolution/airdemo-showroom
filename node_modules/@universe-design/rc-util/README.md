...
[npm-image]: http://img.shields.io/npm/v/@universe-design/rc-util.svg?style=flat-square
[npm-url]: http://npmjs.org/package/@universe-design/rc-util
...
[download-image]: https://img.shields.io/npm/dm/@universe-design/rc-util.svg?style=flat-square
[download-url]: https://npmjs.org/package/@universe-design/rc-util

## Install

[![@universe-design/rc-util](https://nodei.co/npm/@universe-design/rc-util.png)](https://npmjs.org/package/@universe-design/rc-util)
...
```jsx
import createChainedFunction from '@universe-design/rc-util/lib/createChainedFunction';
```
...
```jsx
import deprecated from '@universe-design/rc-util/lib/deprecated';
```
...
```jsx
import getContainerRenderMixin from '@universe-design/rc-util/lib/getContainerRenderMixin';
```
...
```jsx
import Portal from '@universe-design/rc-util/lib/Portal';
```
...
```jsx
import getScrollBarSize from '@universe-design/rc-util/lib/getScrollBarSize';
```
...
```jsx
import guid from '@universe-design/rc-util/lib/guid';
```
...
```jsx
import pickAttrs from '@universe-design/rc-util/lib/pickAttrs';
```
...
```jsx
import warn from '@universe-design/rc-util/lib/warn';
```
...
```jsx
import warning, { noteOnce } from '@universe-design/rc-util/lib/warning';
...
```jsx
import mapSelf from '@universe-design/rc-util/lib/Children/mapSelf';
```
...
```jsx
import toArray from '@universe-design/rc-util/lib/Children/toArray';
```
...
```jsx
import addEventlistener from '@universe-design/rc-util/lib/Dom/addEventlistener';
```
...
```jsx
import canUseDom from '@universe-design/rc-util/lib/Dom/canUseDom';
```
...
```jsx
import cssClass from '@universe-design/rc-util/lib/Dom/class;
```
...
```jsx
import contains from '@universe-design/rc-util/lib/Dom/contains';
```
...
```jsx
import css from '@universe-design/rc-util/lib/Dom/css';
```
...
```jsx
import focus from '@universe-design/rc-util/lib/Dom/focus';
```
...
```jsx
import support from '@universe-design/rc-util/lib/Dom/support';
```
...
```jsx
import KeyCode from '@universe-design/rc-util/lib/KeyCode';
```
...
```js
import ScrollLocker from '@universe-design/rc-util/lib/Dom/scrollLocker';
