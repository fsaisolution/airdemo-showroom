...
var _contains = _interopRequireDefault(require("@universe-design/rc-util/lib/Dom/contains"));

var _findDOMNode = _interopRequireDefault(require("@universe-design/rc-util/lib/Dom/findDOMNode"));

var _ref2 = require("@universe-design/rc-util/lib/ref");

var _addEventListener = _interopRequireDefault(require("@universe-design/rc-util/lib/Dom/addEventListener"));

var _Portal = _interopRequireDefault(require("@universe-design/rc-util/lib/Portal"));
...
function generateTrigger(PortalComponent) {
  var Trigger = /*#__PURE__*/function (_React$Component) {
    ...
    function Trigger(props) {
      ...
      _this.onPopupMouseDown = function (event) {
        ...
        if (_this.context) {
          _this.context.onPopupMouseDown(event);
        }
      };
