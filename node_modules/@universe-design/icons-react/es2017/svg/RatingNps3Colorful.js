...
const svgStr = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M11.228 15.956c1.899 0 3.171-1.246 3.291-2.689.127-1.534-.886-2.446-2.075-2.48l2.185-1.778.117-1.407H9.269l-.122 1.465h3.323l-2.276 1.904.642 1.189c.194-.104.5-.174.744-.174.695 0 1.264.393 1.194 1.235-.055.67-.59 1.246-1.435 1.246-.822 0-1.34-.588-1.305-1.43l-1.673.346c.002 1.373 1.026 2.573 2.867 2.573Z" fill="#fff"/>
</svg>
`;
var svgStr$1 = svgStr;
