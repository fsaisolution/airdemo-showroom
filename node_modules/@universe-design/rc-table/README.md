...
[npm-image]: http://img.shields.io/npm/v/@universe-design/rc-table.svg?style=flat-square
[npm-url]: http://npmjs.org/package/@universe-design/rc-table
...
[download-image]: https://img.shields.io/npm/dm/@universe-design/rc-table.svg?style=flat-square
[download-url]: https://npmjs.org/package/@universe-design/rc-table
[bundlephobia-url]: https://bundlephobia.com/result?p=@universe-design/rc-table
[bundlephobia-image]: https://badgen.net/bundlephobia/minzip/@universe-design/rc-table

## install

[![@universe-design/rc-table](https://nodei.co/npm/@universe-design/rc-table.png)](https://npmjs.org/package/@universe-design/rc-table)
...
```js
import Table from '@universe-design/rc-table';
...
| prefixCls | String | @universe-design/rc-table |  |
...
@universe-design/rc-table is released under the MIT license.
