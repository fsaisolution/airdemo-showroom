...
.rc-table__sticky--pinned-top {
  box-shadow: 0 10px 8px -8px green;
}
.rc-table__sticky--pinned-bottom {
  box-shadow: 0 -10px 8px -8px green;
}
...
.rc-table.rc-table-scrollbar-hidden .rc-table-content::-webkit-scrollbar-thumb,
.rc-table.rc-table-scrollbar-hidden .rc-table-body::-webkit-scrollbar-thumb {
  background-color: transparent;
}
.rc-table-group-row .rc-table-group-row-cell {
  padding: 0;
}
.rc-table__divider {
  opacity: 0;
...
.rc-table__divider--left {
  box-shadow: 2px 0 5px  green;
  right: -1px;
}
.rc-table__divider--right {
  box-shadow: -2px 0 5px green;
  left: -1px;
}
.rc-table__divider--visible {
  opacity: 1;
}
