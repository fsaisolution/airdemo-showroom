...
import { supportRef } from "@universe-design/rc-util/es/ref";
import { getPathValue } from '../utils/valueUtil';
import { CellFixedDivider } from './FixedDivider';
...
function Cell(_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, componentProps, appendNode, childNode, lastFixLeft && /*#__PURE__*/React.createElement(CellFixedDivider, {
    position: "left"
  }), firstFixRight && /*#__PURE__*/React.createElement(CellFixedDivider, {
    position: "right"
  }));
}
