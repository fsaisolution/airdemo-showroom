...
export interface GroupConfig<RecordType> {
    groupBy?: Key | ((record: RecordType) => Key);
    groupRowRenderer?: (groupKey: Key, expanded: boolean) => React.ReactNode;
    defaultExpandedGroupKeys?: Key[];
    defaultExpandAllGroups?: boolean;
    onGroupRow?: (groupKey: Key) => React.HTMLAttributes<HTMLElement>;
}
