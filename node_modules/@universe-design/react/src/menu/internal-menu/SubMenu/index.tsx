...
export interface RcSubMenuProps {
...
const InternalSubMenu = (props: RcSubMenuProps) => {
  const {
    style,
    className,
  ...
  const domDataId = useMenuId(eventKey!) || undefined;
  ...
  const onMergedItemClick = useMemoCallback((info: RcMenuInfo) => {
    ...
    titleNode = (
      <PopupTrigger
        ...
        popup={
          ...
          >
            <RcSubMenuList id={popupId || undefined} ref={popupRef}>
              {children}
            </RcSubMenuList>
          </MenuContextProvider>
        }
...
export default function RcSubMenu(props: RcSubMenuProps) {
  ...
  return <PathTrackerContext.Provider value={connectedKeyPath}>{renderNode}</PathTrackerContext.Provider>;
}
