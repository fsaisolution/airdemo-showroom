...
import omit from '@universe-design/rc-util/lib/omit';
import type { MenuClickEventHandler, RcMenuInfo, MenuHoverEventHandler, RenderIconType } from './interface';
...
export interface RcMenuItemProps
 ...
 */
const InternalMenuItem = (props: RcMenuItemProps) => {
  const {
    style,
    className,
  ...
  // ============================= Info =============================
  const getEventInfo = (e: React.MouseEvent<HTMLElement> | React.KeyboardEvent<HTMLElement>): RcMenuInfo => ({
    key: eventKey!,
  ...
  // ============================ Active ============================
  const { active, ...activeProps } = useActive(eventKey!, mergedDisabled, onMouseEnter, onMouseLeave);
...
function RcMenuItem(props: RcMenuItemProps): React.ReactElement | null {
