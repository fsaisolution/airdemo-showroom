    ...
    >
      ...
      <div style={{ height: 500, overflow: 'scroll' }} ref={container}>
        <div style={{ height: 700 }}>
          {' '}
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore aliquid neque accusamus suscipit asperiores,
          id ullam in iste soluta dignissimos vero incidunt, rem ex consectetur beatae totam aperiam. Sunt, laudantium?
        </div>
        <Table<RecordType>
          columns={fixedColumns}
          dataSource={fixedData}
        ...
        />
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore aliquid neque accusamus suscipit asperiores, id
        ullam in iste soluta dignissimos vero incidunt, rem ex consectetur beatae totam aperiam. Sunt, laudantium?
      </div>
    </div>
  );
};
