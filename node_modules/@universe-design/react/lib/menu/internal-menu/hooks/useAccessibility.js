...
var _KeyCode = _interopRequireDefault(require("@universe-design/rc-util/lib/KeyCode"));
var _raf = _interopRequireDefault(require("@universe-design/rc-util/lib/raf"));
var _focus = require("@universe-design/rc-util/lib/Dom/focus");
...
function getOffset(mode, isRootLevel, isRtl, which) {
  ...
  }[`${mode}${isRootLevel ? '' : 'Sub'}`]) === null || _offsets === void 0 ? void 0 : _offsets[which];
  switch (type) {
    case prev:
      return {
        offset: -1,
...
function useAccessibility(mode, activeKey, isRtl, id, containerRef, getKeys, getKeyPath, triggerActiveKey, triggerAccessibilityOpen, originOnKeyDown) {
  ...
  return e => {
    ...
    if ([...ArrowKeys, ENTER, ESC].includes(which)) {
      ...
      let key2element = new Map();
      let element2key = new Map();
      ...
      if (offsetObj.sibling || !focusMenuElement) {
        ...
        const targetElement = getNextFocusElement(parentQueryContainer, elements, focusMenuElement, offsetObj.offset);
        ...
        // =========================== Level ===========================
      } else if (offsetObj.offset && offsetObj.offset > 0) {
