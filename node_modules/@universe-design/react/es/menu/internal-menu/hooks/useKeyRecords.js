...
export default function useKeyRecords() {
  ...
  const registerPath = useCallback((key, keyPath) => {
    ...
    if (process.env.NODE_ENV !== 'production') {
      process.env.NODE_ENV !== "production" ? warning(!key2pathRef.current.has(key), `Duplicated key '${key}' used in Menu by path [${keyPath.join(' > ')}]`) : void 0;
    }
  ...
  const isSubPathKey = useCallback((pathKeys, eventKey) => pathKeys.some(pathKey => {
...
//# sourceMappingURL=useKeyRecords.js.map
