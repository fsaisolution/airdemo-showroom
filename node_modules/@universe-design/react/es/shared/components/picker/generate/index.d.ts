...
export type GenerateConfig<DateType = Moment> = {
    ...
    formatLabel: (value: DateType | number, format: string) => string;
    ...
    locale: {
        ...
        parse: (locale: string, text: string, format: string) => DateType | null;
